...
describe("fixed-network-municipality-specific-availability Integration Tests", () => {
  ...
  describe("getFixedNetworkMunicipalitySpecificAvailability", () => {
    ...
    it("should handle query parameters correctly", async () => {
      ...
      const response =
        await client.getFixedNetworkMunicipalitySpecificAvailability(params);
